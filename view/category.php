...
$all_categories = mysqli_query($con, $categories_sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-md-9">
            <div class="wrapper p-5 m-5">
                ...
                <div class="d-flex p-2 justify-content-between mb-2">
                    ...
                    <div>
                        <a href="../controller/category/add_category.php" class="btn btn-primary">Add Category</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($all_categories as $category): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../controller/category/edit_category.php?id=<?php echo $category['CategoryID']; ?>"><button
                                            type="button" class="btn btn-primary">Edit</button></a>
                                    <a href="../controller/category/delete_category.php?id=<?php echo $category['CategoryID']; ?>"><button
